...
//               <X size={24} />
//             </button>
//             <h3 className="text-2xl font-bold text-blue-900 mb-6">Start Your SOP Journey</h3>
...
//               </div>
//               <div>
//                 <label className="block text-gray-700 mb-2">Desired Course</label>
//                 <input
//                   type="text"
//                   name="course"
...
//               </div>
//               <div>
//                 <label className="block text-gray-700 mb-2">Target University</label>
//                 <input
//                   type="text"
//                   name="university"
...
//               <motion.button
//                 type="submit"
//                 className="w-full bg-orange-500 text-white py-3 rounded-full font-semibold inline-flex items-center justify-center gap-2"
