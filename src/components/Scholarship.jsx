...
// import { Search, Info } from "react-feather" // Added Info icon import
...
//         <h3 className="text-xl font-bold text-blue-900 mb-2">{data.university || data.country}</h3>
//         {data.name && <p className="text-blue-600 font-semibold mb-4">{data.name}</p>}
...
// // CountryTab component
// const CountryTab = ({ country, isActive, onClick }) => (
//   <button
//     onClick={onClick}
//     className={`px-6 py-2 rounded-full transition-all ${
//       isActive ? "bg-blue-900 text-white" : "bg-white text-blue-900 hover:bg-blue-50"
//     }`}
//   >
//     {country}
//   </button>
...
//         {
//           university: "Victoria University of Wellington",
//           name: "Vice Chancellor's nternational Excellence Scholarship",
...
//   const [activeCountry, setActiveCountry] = useState("USA") // Changed to "USA"
...
//     if (!data) return <p className="text-gray-600">No scholarships available for this country.</p>;
...
//                 activeTab === "Undergraduate" ? "bg-orange-500 text-white" : "bg-white text-orange-500"
//               }`}
...
//             <button
//               className={`px-6 py-2 rounded-full ${
//                 activeTab === "Postgraduate" ? "bg-orange-500 text-white" : "bg-white text-orange-500"
//               }`}
...
//               <ScholarshipCard key={index} data={scholarship} />
//             ))}
//           </div>
//         </>
//       );
...
//             <ScholarshipCard key={index} data={info} />
//           ))}
//         </div>
//       );
//     }
...
//       {/* Hero Section */}
//       <section className="pt-24 pb-16 bg-gradient-to-br from-blue-900 to-blue-800">
...
//           >
//             <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Global Scholarship Opportunities</h1>
...
//                   <li>• All scholarship amounts are subject to change without prior notice</li>
//                   <li>• Eligibility criteria must be met to qualify for scholarships</li>
//                   <li>• Application deadlines vary by institution</li>
//                   <li>• Additional documentation may be required</li>
//                   <li>• Scholarships are awarded at the discretion of the institutions</li>
//                   <li>• Academic requirements and test scores must meet minimum criteria</li>
//                   <li>• Some scholarships may require separate applications</li>
//                   <li>• Renewal conditions may apply for multi-year scholarships</li>
//                 </ul>
//               </div>
//             </div>
//           </motion.div>
...
//               { label: "Scholarships Available", value: "1000+" },
    ...
    <div className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      {/* <section className="py-16 bg-gradient-to-br from-orange-500 to-orange-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { label: "Partner Universities", value: "500+", icon: <BookOpen className="w-8 h-8" /> },
              { label: "Countries", value: "15+", icon: <Globe className="w-8 h-8" /> },
              { label: "Scholarships Available", value: "1000+", icon: <Award className="w-8 h-8" /> },
              { label: "Success Rate", value: "95%", icon: <ChevronRight className="w-8 h-8" /> },
            ].map((stat, index) => (
              <motion.div
                key={index}
...
>
  ...
  <div className="container mx-auto px-4 relative z-10">
    <div className="grid md:grid-cols-4 gap-8">
      {[
        { label: "Partner Universities", value: 500, suffix: "+", icon: <BookOpen className="w-8 h-8" /> },
        { label: "Countries", value: 15, suffix: "+", icon: <Globe className="w-8 h-8" /> },
