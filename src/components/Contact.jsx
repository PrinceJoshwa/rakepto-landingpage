...
// // SuccessAnimation component is removed
...
//   // const [submitMessage, setSubmitMessage] = useState("") // No longer needed
...
//     // setSubmitMessage("") // No longer needed
//     setSubmitError("")
...
//       // setSubmitMessage("Thank you for your message! We'll get back to you soon.") // No longer needed
...
//             {/* Success message overlay is removed */}
...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/xwprdgvz", {
        method: "POST",
        body: JSON.stringify(contactData),
        headers: {
          "Content-Type": "application/json",
