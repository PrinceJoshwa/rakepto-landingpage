...
//         <h2 className="text-2xl font-bold mb-6 text-center">Partner Sign Up</h2>
...
//               required
//               className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-indigo-200 focus:outline-none"
//             />
//           </div>
//           <div>
